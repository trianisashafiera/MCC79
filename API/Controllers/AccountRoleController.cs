...
public class AccountRoleController : ControllerBase
{
    ...
    public IActionResult GetAll()
    {
        ...
        return Ok(new ResponseHandler<IEnumerable<NewAccountRoleDto>>
        {
    ...
    public IActionResult Create(NewAccountRoleDto newAccountRoleDto)
    {
        ...
        {
            return BadRequest(new ResponseHandler<NewAccountRoleDto>
            {
    ...
    [HttpPut]
    public IActionResult Update(NewAccountRoleDto updateAccountRoleDto)
    {
